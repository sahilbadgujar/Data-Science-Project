...
import numpy as np
import pandas as pd
from sklearn.compose import ColumnTransformer # it is used when we have to do one hot encoding or standardscalimg in the form of pipelining
...
class DataTransformationConfig:
    preprocesspr_obj_file_path = os.path.join("artifact", "preprocessor.pkl")
...
class DataTransformation:
    ...
    def get_data_transformar_obj(self):
        ''' This function is resonable for all type of data transformation'''
        try:
            ...
            logging.info(f"Numerical categories: {numerical_columns}")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            return {
                "train_arr": train_arr,
                "test_arr": test_arr,
                "preprocessor_path": self.data_transformation_config.preprocesspr_obj_file_path,
            }
